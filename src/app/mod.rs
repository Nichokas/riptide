...
pub struct App {
    ...
    pub pending_track_removals: Vec<u64>,
    pub pending_album_removals: Vec<u64>,
    pub suppressed_track_removals: Vec<u64>,
...
impl App {
    pub fn new(
        ...
        let mut app = Self {
            ...
            status: None,
            undo_entry: None,
            pending_track_removals: Vec::new(),
            pending_album_removals: Vec::new(),
            suppressed_track_removals: Vec::new(),
