    ...
    pub fn global() -> Self {
        KeybindGroup {
            ...
            binds: &[
                ...
                Keybind { key: "u", action: "Undo last removal" },
    ...
    pub fn navigation() -> Self {
        KeybindGroup {
            ...
            binds: &[
                ...
                Keybind { key: "f", action: "Favorite (add, d to remove) / Toggle follow or save" },
                Keybind { key: "d", action: "Remove from favorites" },
                Keybind { key: "u", action: "Undo last removal" },
    ...
    pub fn queue() -> Self {
        KeybindGroup {
            ...
            binds: &[
                ...
                Keybind { key: "u", action: "Undo unavailable in queue" },
                Keybind { key: "c", action: "Copy share link (song)" },
